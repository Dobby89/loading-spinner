class AoSpinner {
    ...
    createDomElement() {
        ...
        let loadingTextEl = `<div class="${parsedData.classes.progress}" style="display: none; color: ${parsedData.colour};">${parsedData.loadingText}</div>`;
        if (parsedData.loadingText) {
            loadingTextEl = `<div class="${parsedData.classes.progress}" style="color: ${parsedData.colour};">${parsedData.loadingText}</div>`;
        }
        let html = `
                ...
                <div class="${parsedData.classes.content}">
                    <div class="${parsedData.classes.logoContainer}" style="width: ${parsedData.logoWidth}; height: ${parsedData.logoHeight};">
                        <div class="${parsedData.classes.bounce}">
                            <svg class="${parsedData.classes.logo}" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
